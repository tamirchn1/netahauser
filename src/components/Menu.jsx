  ...
  return (
    <div class="container"> 
        <div className="menu">
          ...
          <a href="https://api.whatsapp.com/send?phone=+972545428382נטע האוזר" className="nav-link col-lg-4" target="_blank" rel="noreferrer">שיחה או התכתבות בוואטספ להתייעצות חינם</a>
      </div>
     </div>
  );
  }
